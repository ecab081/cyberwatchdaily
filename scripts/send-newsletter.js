...
function getLatestBlogPost() {
  try {
    ...
    return { title: title, excerpt: excerpt, category: category, url: url };
  } catch (e) {
    console.log('Blog post error: ' + e.message);
    return null;
  }
}
  ...
  return '<!DOCTYPE html><html><head><meta charset="UTF-8"></head>' +
    ...
    '<tr><td style="background:#0d1317;padding:20px 28px;border-top:1px solid rgba(0,255,136,0.1);">' +
      ...
      '<table width="100%" cellpadding="0" cellspacing="0">' +
        ...
        '<tr><td style="padding:6px 0;border-bottom:1px solid #1e2d1e;"><span style="color:#e0edd6;font-size:13px;">Bitwarden</span> <span style="color:#7a9e8a;font-size:12px;">Open-source password manager</span><a href="https://bitwarden.com" style="float:right;font-family:monospace;font-size:11px;color:#00ff88;">Try Free</a></td></tr>' +
        '<tr><td style="padding:6px 0;border-bottom:1px solid #1e2d1e;"><span style="color:#e0edd6;font-size:13px;">DeleteMe</span> <span style="color:#7a9e8a;font-size:12px;">Remove your data from the web</span><a href="https://joindeleteme.com/refer?coupon=DELETEME10" style="float:right;font-family:monospace;font-size:11px;color:#00ff88;">10% Off</a></td></tr>' +
        '<tr><td style="padding:6px 0;"><span style="color:#e0edd6;font-size:13px;">Aura</span> <span style="color:#7a9e8a;font-size:12px;">Identity theft protection</span><a href="https://www.aura.com/" style="float:right;font-family:monospace;font-size:11px;color:#00ff88;">Try Free</a></td></tr>' +
      '</table>' +
    '</td></tr>' +
